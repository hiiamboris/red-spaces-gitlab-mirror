...
| `list-view` | scrollable vertical list of data | [list-view](reference.md#list-view) | none | tight left center right top middle bottom selectable multi-selectable |
